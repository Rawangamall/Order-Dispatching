...
exports.RoleValidPOST =[
    ...
    body('orders.add').optional().isBoolean().withMessage('Orders add must be a boolean'),
    body('orders.edit').optional().isBoolean().withMessage('Orders edit must be a boolean'),
    body('orders.delete').optional().isBoolean().withMessage('Orders delete must be a boolean'),
